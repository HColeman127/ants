define("vector2D", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("utils", ["require", "exports", "vector2D"], function (require, exports, vector2D_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Utils = (function () {
        function Utils() {
        ...
        Utils.get_mouse_pos = function (event, element) {
            ...
            return new vector2D_js_1.default(event.clientX - rect.left, event.clientY - rect.top);
        };
...
define("types", ["require", "exports", "vector2D"], function (require, exports, vector2D_js_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MouseData = void 0;
    var MouseData = (function () {
        function MouseData(element) {
            this.element = element;
            this.rect = element.getBoundingClientRect();
            this.pos = vector2D_js_2.default.ZERO;
        ...
        MouseData.prototype.add_listeners = function () {
            ...
            window.addEventListener('mousemove', function (event) {
                _this.pos = new vector2D_js_2.default(event.clientX - _this.rect.left, event.clientY - _this.rect.top);
            });
...
define("ant", ["require", "exports", "vector2D", "utils"], function (require, exports, vector2D_js_3, utils_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Ant = (function () {
            ...
            for (var x = -20; x <= 20; x++) {
                for (var y = -20; y <= 20; y++) {
                    if (Math.pow(x, 2) + Math.pow(y, 2) <= Math.pow(20, 2))
                        pts.push(new vector2D_js_3.default(x, y));
                }
            }
        ...
        Ant.prototype.find_max_in_circle = function (marker) {
            ...
            return new vector2D_js_3.default(max_x - x0, max_y - y0);
        };
        Ant.prototype.move = function (structures) {
            ...
            if (structures[utils_js_1.default.index_of(new_pos_int)] === 1) {
                this.bounce();
                return;
            }
            else if (structures[utils_js_1.default.index_of(new_pos_int)] === 2 && !this.has_food) {
                structures[utils_js_1.default.index_of(new_pos_int)] = 0;
                this.has_food = true;
                this.potency = 255;
                this.desired_aim = this.aim.negative();
            }
            this.pos = new vector2D_js_3.default(utils_js_1.default.clamp(new_pos.x, 0, 500), utils_js_1.default.clamp(new_pos.y, 0, 375));
            this.wall_count = 0;
        };
        Ant.prototype.bounce = function () {
            this.pos = this.pos.minus(this.aim);
            this.desired_aim = vector2D_js_3.default.ZERO;
            this.wall_count++;
            if (this.wall_count > 100) {
                this.pos = new vector2D_js_3.default(20, 20);
            }
        };
        Ant.prototype.drop_marker = function (marker) {
            var index = utils_js_1.default.index_of(this.pos);
            marker[index] = Math.max(marker[index], utils_js_1.default.trunc(this.potency));
        };
...
define("map", ["require", "exports", "vector2D", "utils", "ant"], function (require, exports, vector2D_js_4, utils_js_2, ant_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Map = (function () {
        function Map() {
            ...
            for (var i = 0; i < 1000; i++) {
                this.ants.push(new ant_js_1.default(new vector2D_js_4.default(25, 25), vector2D_js_4.default.random()));
            }
        ...
        Map.prototype.apply_brush = function (pos, radius, value) {
            var _this = this;
            utils_js_2.default.loop_clamped_circle(pos, radius, function (x, y) {
                var index = x + y * 500;
...
define("draw", ["require", "exports", "utils"], function (require, exports, utils_js_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var DrawHelper = (function () {
        ...
        DrawHelper.prototype.init_listeners = function () {
            ...
            this.canvas.addEventListener('wheel', function (event) {
                _this.brush.radius = utils_js_3.default.clamp(_this.brush.radius - utils_js_3.default.sign(event.deltaY), 0, 100);
            });
        };
...
define("main", ["require", "exports", "map", "types", "draw"], function (require, exports, map_js_1, types_js_1, draw_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var p1;
    var map;
    ...
    window.addEventListener('load', function () {
        ...
        map = new map_js_1.default();
        draw = new draw_js_1.default('canvas');
        mouse = new types_js_1.MouseData(draw.canvas);
